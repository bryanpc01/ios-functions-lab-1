...
///* 15. Write a function that flips a dictionary.  All of the keys are now values and all of the values are now keys.
//
// Example:
// Input: `[1: "hi", 5: "bye:]`
// 
...
///* 16. Write a function that finds the person with the second highest test score in a Dictionary that maps names to scores.
//
// Example:
...
///* 17. Write a function that determines if a value is inside of array.
// */
...
///* 18. Write a function takes an `Int` as input, and returns true if it is even, or false if it is odd.
...
///* 19. Write a function that takes `[Int]` as input. It should return the largest Int in the array.
// */
...
///* 20.Write a function that takes a String as input and returns the number of characters in the string
//
...
///* 21. Write a function that counts how many characters in a String match a specific character.  (e.g: count how many "a"s are in a String, or count how many ","s are in a String.
//
// Example:
// Input:
// ```swift
...
///* 22. Write a function that counts how many characters in a String match one of several possible characters.  (e.g: count how many vowels are in a String, or count how many "a"s "b"s and "c"s are in a Sting)
//
// Example:
// Input:
// ```swift
...
///* 23. Write a function that returns the number of unique Ints in an array of Ints.
//
// Example:
...
///* 24. Write a function that converts a binary number into decimal. The binary number will be given as an array of Ints.
//
// Example:
...
///* 25. Write a function named `timeDifference`. It takes as input four numbers that represent two times in a day and returns the difference in minutes between them. The first two parameters `firstHour` and `firstMinute` represent the hour and minute of the first time. The last two `secondHour` and `secondMinute` represent the hour and minute of the second time. All parameters should have external parameter names with the same name as the local ones.
//
// Example:
...
///* 26. Write a function called `filterOdd` that takes an array of ints and returns it with just the even numbers.
//
// Example:
...
///* 27. Write a function called `doubleIt` that takes an array of ints and returns it with all the elements doubled.
//
// Example:
...
///* 28. Write a function called `unwrap` that takes an array of optional ints and returns an array with them unwrapped with any nil values removed.
//
// Example:
...
///* 29. Write a function that takes an array of bools and returns a dictionary that maps the bools to how many times they appear in the array.
//
// Example:
...
///* 30. Write a function that takes a string as input and returns a dictionary that maps each unique character to how many times they appear in the string.
//
// Example:
...
///* 31. Write a function that takes this dictionary of baseball teams by ID and returns an array of tuples that contain each team's ID and name.
//
...
///* 32. Write a function that checks if a String is a [Palindrome](https://en.wikipedia.org/wiki/Palindrome)
// */
...
///* 33. Write a function that checks if a String is a [pangram](https://en.wikipedia.org/wiki/Pangram)
// */
...
///* 34. Write your own `min()` and `max()` functions for an Array of Ints
// */
//
//
...
///* 35. Given two arrays of Ints, write a function that tells you all the values they have in common.
// */
//let input1 = [1,2,3]
//let input2 = [2,3,4]
...
///* 36. Find the most-frequently appearing Array of Ints in an Array of Arrays of Ints.
// */
...
///* 37. Given a String as input, rotate all a-z characters by one.  This is called [ROT-1 encryption](http://www.rot-n.com/).
// 
// Sample input:
